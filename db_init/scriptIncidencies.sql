...
ALTER TABLE INCIDENCIA ADD FOREIGN KEY (ID_TECNIC) REFERENCES TECNIC(ID_TECNIC) ON DELETE CASCADE;
ALTER TABLE INCIDENCIA ADD FOREIGN KEY (ID_ACTUACIO) REFERENCES ACTUACIO(ID_ACTUACIO) ON DELETE CASCADE;
ALTER TABLE ACTUACIO ADD FOREIGN KEY (ID_INCIDENCIA) REFERENCES INCIDENCIA(ID_INCIDENCIA) ON DELETE CASCADE;